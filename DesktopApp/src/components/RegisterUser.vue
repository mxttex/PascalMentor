...
const indirizzo = ref<string>('Informatica')
const dataNascita = ref<string>('')
...
async function handleSubmit(): Promise<void> {
    ...
    const endpoint:string = `http://localhost:8089/api/register`
...
.defaultButton {
    ...
    white-space: nowrap;
    width: auto;
    /* meglio auto per bottoni affiancati */
    min-width: 120px;
}
